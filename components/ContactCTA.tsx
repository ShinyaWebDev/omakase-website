...
export default function ContactCTA({ contact, pageText }: Props) {
  ...
  const ctaHeading = lang === 'en'
    ? (pageText?.home_cta_heading_en || 'Ready to Book?')
  ...
  const note =
    lang === 'en' ? contact?.booking_note_en : contact?.booking_note_ja
  ...
  return (
    <section className="py-20 bg-teal text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-white/75 text-lg mb-3 max-w-xl mx-auto leading-relaxed">{ctaBody}</p>

        {note && (
          <p className="text-white/60 text-sm mb-8 italic">{note}</p>
        )}
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {whatsappUrl && (
            <a
              ...
              className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-white text-[#25D366] font-semibold rounded-full hover:bg-white/90 transition-colors shadow-md"
            >
          ...
          {lineUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-white text-[#06C755] font-semibold rounded-full hover:bg-white/90 transition-colors shadow-md"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          {phoneUrl && contact?.phone && (
            <a
              href={phoneUrl}
              className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-white text-navy font-semibold rounded-full hover:bg-white/90 transition-colors shadow-md"
            >
